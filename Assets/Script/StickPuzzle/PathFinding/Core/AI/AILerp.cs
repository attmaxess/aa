...
namespace Pathfinding
{
    ...
    public class AILerp : VersionedMonoBehaviour, IAstarAI
    {
        ...
        public delegate void HandleOnTargetReached(Seeker seeker);
        public HandleOnTargetReached handleOnTargetReached;

        public delegate void OnPostFinalizeMovement(AILerp lerp);
        public OnPostFinalizeMovement onpostFinalizeMovement;
        ...
        {
            if (handleOnTargetReached != null)
                handleOnTargetReached.Invoke(GetComponent<Seeker>());
        }
        ...
        public void FinalizeMovement(Vector3 nextPosition, Quaternion nextRotation)
        {
            ...
            if (onpostFinalizeMovement != null)
                onpostFinalizeMovement.Invoke(this);
        }
